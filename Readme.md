...
🔭 Currently a Software Engineering  - cybersec, programming, and information security are my passions.<br>💻 infatuated with security-oriented development projects, CTFs, Hacking and writeups.<br>🤝 currently looking into -  cryptography and web technologies, DevOps/DevSecOps tools and concepts.<br>💬 Ask me about - Reverse engineering, Forensics, steganography, mobile OS exploits, Troubleshooting and penetration testing.<br>⚡ Fun fact - I can fix your laptop!
